...
public class TestLinkedBinaryTree implements Test {
    ...
    public void run() {
        ...
        addRoot(tree, "A");
        LinkedBinaryTree.Node<String> nodeA = tree.root(); 
        addLeft(tree, nodeA, "A0");
        LinkedBinaryTree.Node<String> nodeA0 = tree.left(nodeA); 
        addRight(tree, nodeA, "A1");
        LinkedBinaryTree.Node<String> nodeA1 = tree.right(nodeA); 
        element(tree, nodeA);
        element(tree, nodeA0);
        element(tree, nodeA1);
        root(tree);
        ...
        LinkedBinaryTree.Node<String> nodeA00 = tree.left(nodeA0); 
